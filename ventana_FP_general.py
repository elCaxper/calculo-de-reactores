...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout_4.setWidget(0, QtGui.QFormLayout.LabelRole, self.lb_cao_15)
        self.le_inerte = QtGui.QLineEdit(self.Reaccion)
        self.le_inerte.setMinimumSize(QtCore.QSize(65, 0))
        self.le_inerte.setObjectName(_fromUtf8("le_inerte"))
        self.formLayout_4.setWidget(0, QtGui.QFormLayout.FieldRole, self.le_inerte)
